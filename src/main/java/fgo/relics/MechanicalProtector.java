...
public class MechanicalProtector extends CustomRelic {
    ...
    private static final String IMG = "img/relics_Master/MechanicalProtector.png";
    private static final String IMG_OTL = "img/relics_Master/outline/MechanicalProtector.png";
