...
public class MidsummerNightDream extends CustomRelic {
    ...
    private static final String IMG = "img/relics_Master/MidsummerNightDream.png";
    private static final String IMG_OTL = "img/relics_Master/outline/MidsummerNightDream.png";
