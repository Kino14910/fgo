...
public class MisoPotato extends CustomRelic {
    ...
    private static final String IMG = "fgo/images/relics_Master/MisoPotato.png";
    private static final String IMG_OTL = "fgo/images/relics_Master/outline/MisoPotato.png";
