...
public class CosmicMedallion extends CustomRelic {
    ...
    private static final String IMG = "img/relics_Master/CosmicMedallion.png";
    private static final String IMG_OTL = "img/relics_Master/outline/CosmicMedallion.png";
