...
public class CosmicMedallion extends CustomRelic {
    ...
    private static final String IMG = "fgo/images/relics_Master/CosmicMedallion.png";
    private static final String IMG_OTL = "fgo/images/relics_Master/outline/CosmicMedallion.png";
