...
@Deprecated
public class QuickPerformancePower extends AbstractPower {
    ...
    public QuickPerformancePower(AbstractCreature owner, int amount) {
        ...
        String path128 = "img/powers_Master/QuickPerformancePower84.png";
        String path48 = "img/powers_Master/QuickPerformancePower32.png";
