...
@Deprecated
public class ArtsCardPower extends AbstractPower {
    ...
    public ArtsCardPower(AbstractCreature owner) {
        ...
        String path128 = "img/powers_Master/ArtsCardPower84.png";
        String path48 = "img/powers_Master/ArtsCardPower32.png";
