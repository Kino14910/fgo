...
@Deprecated
public class QuickCardPower extends AbstractPower {
    ...
    public QuickCardPower(AbstractCreature owner) {
        ...
        String path128 = "img/powers_Master/QuickCardPower84.png";
        String path48 = "img/powers_Master/QuickCardPower32.png";
