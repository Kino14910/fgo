...
public class CurseHarmonyPower extends AbstractPower {
    public static final String POWER_ID = "CurseHarmonyPower";
    ...
    public CurseHarmonyPower(AbstractCreature owner, int amount) {
        ...
        String path128 = "fgo/images/powers_Master/ThirstForVengeancePower84.png";
        String path48 = "fgo/images/powers_Master/ThirstForVengeancePower32.png";
