...
public class LivingFlamePower extends AbstractPower {
    public static final String POWER_ID = "LivingFlamePower";
    ...
    public LivingFlamePower(AbstractCreature owner, int amount) {
        ...
        String path128 = "fgo/images/powers_Master/LivingFlamePower84.png";
        String path48 = "fgo/images/powers_Master/LivingFlamePower32.png";
