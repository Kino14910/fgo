...
public class StarGainMonsterPower extends AbstractPower {
    public static final String POWER_ID = "StarGainMonsterPower";
    ...
    public StarGainMonsterPower(AbstractCreature owner, int amount) {
        ...
        String path128 = "img/powers_Master/StarGainPower84.png";
        String path48 = "img/powers_Master/StarGainPower32.png";
