...
public class SevenBeastCrownsPower extends AbstractPower {
    public static final String POWER_ID = "SevenBeastCrownsPower";
    ...
    public SevenBeastCrownsPower(AbstractCreature owner, int amount) {
        ...
        String path128 = "fgo/images/powers_Master/DracoPower84.png";
        String path48 = "fgo/images/powers_Master/DracoPower32.png";
