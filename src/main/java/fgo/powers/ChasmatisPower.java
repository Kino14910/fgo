...
public class ChasmatisPower extends AbstractPower {
    public static final String POWER_ID = "ChasmatisPower";
    ...
    public ChasmatisPower(AbstractCreature owner, int amount) {
        ...
        String path128 = "fgo/images/powers_Master/OriginBulletPower84.png";
        String path48 = "fgo/images/powers_Master/OriginBulletPower32.png";
