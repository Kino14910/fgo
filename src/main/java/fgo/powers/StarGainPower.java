...
public class StarGainPower extends AbstractPower {
    ...
    public StarGainPower(AbstractCreature owner, int amount) {
        ...
        String path128 = "fgo/images/powers_Master/StarGainPower84.png";
        String path48 = "fgo/images/powers_Master/StarGainPower32.png";
